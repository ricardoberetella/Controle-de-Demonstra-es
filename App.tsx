      ...
      <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border border-slate-700">
          <div className="bg-[#004B95] p-10 text-center">
            <div className="inline-block bg-[#E30613] text-white px-6 py-2 font-black text-3xl italic skew-x-[-12deg] mb-8 shadow-xl">
              SENAI
            </div>
      ...
      <header className="bg-[#004B95] shadow-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-28 flex items-center justify-between gap-4">
          <div className="flex items-center shrink-0">
             <div className="bg-[#E30613] text-white px-5 py-1.5 font-black text-2xl italic skew-x-[-12deg] shadow-lg">SENAI</div>
          </div>
            ...
            <div className="flex bg-black/20 p-1 rounded-xl gap-1">
              {classes.map((c, index) => (
                <button 
                  ...
                  className={`px-3 py-2 rounded-lg text-[10px] font-black uppercase tracking-tight transition-all whitespace-nowrap ${activeClassId === c.id ? 'bg-white text-[#004B95] shadow-md' : 'text-white/60 hover:text-white'}`}
                >
